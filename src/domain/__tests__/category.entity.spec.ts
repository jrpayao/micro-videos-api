...
describe("Category Validator", () => {
    describe("create command", () => {
        test("should an invalid category with name property", () => {
            ...
            expect(() => CategoryEntity.create({ name: null })).containsErrorMessages({
                name: [
            ...
            expect(() => CategoryEntity.create({ name: "" })).containsErrorMessages({
                name: ["name should not be empty"],
            });

            expect(() => CategoryEntity.create({ name: 5 as any })).containsErrorMessages({
                name: [
                    "name must be a string",
                    "name must be shorter than or equal to 255 characters",
                ],
            ...
            expect(() =>
                CategoryEntity.create({ name: "t".repeat(256) })
        ...
        it("should a invalid category using description property", () => {
            expect(() =>
                CategoryEntity.create({ description: 5 } as any)
            ).containsErrorMessages({
        ...
        it("should a invalid category using is_active property", () => {
            expect(() =>
                CategoryEntity.create({ is_active: 5 } as any)
            ).containsErrorMessages({
